...
<div class="site-contact">
    ...
    <p>
Предоставим помощь в кредитовании и лизинге
Автосалон "Автолекс" аккредитован во всех федеральных банках, предоставляющих 
услуги кредитования, а так же во всех компаниях, осуществляющих лизинг для клиентов.</p>
<p>Процентная ставка по кредиту составляет от 11,9% годовых без первоначального взноса!
Возможна дистанционная подача заявки.
И только по двум документам удостоверяющим личность (подробности уточняйте у менеджеров).</p>
<p>
